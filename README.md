...
This Repo is a modification of the official implementation of Pix2Pix: https://github.com/junyanz/pytorch-CycleGAN-and-pix2pix. This Repo uses Pix2Pix to handle audio data for the purpose of Audio Augmentation.The model adds noise to clean audio.
